...
<section
	id="BCard"
	class="flex flex-col w-[90%] max-w-5xl ml-auto mr-auto mt-[1.5rem] mb-[1.5rem] bg-[var(--color-primary-container)] box-border rounded-4xl"
>
	<div
		id="header"
